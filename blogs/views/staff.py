...
def review_flow(request):
    ...
    for blog in blogs:
        ...
        if (
            ...
            strings_to_check = ['ooc', 'infp', 'she/her', 'he/him', 'they/them', 'masc terms', 'fem terms', 'pronouns', 'dni', 'Aries', 'Taurus', 'Gemini', 'Cancer', 'Leo', 'Virgo', 'Libra', 'Scorpio', 'Sagittarius', 'Capricorn', 'Aquarius', 'Pisces']
